...
package com.google.sitebricks.mail.smtpxoauth;
...
public class XoauthAuthenticator {
   ...
   */
  public OAuthConsumer getAnonymousConsumer() {
   ...
   */
  public IMAPSSLStore connectToImap(String host,
                                           int port,
                                           String userEmail,
                                           String oauthToken,
   ...
   *
   * @return A session obj that can be used for creating messages
   */
  public void connectToSmtp(String host,
                                            int port,
                                            String userEmail,
                                            String oauthToken,
                                            String oauthTokenSecret,
